$(function () {
	...
	module('collapse object');
		...
		test('should toggle the target on toggle()', function() {
			...
			equal($('#qunit-fixture .collapsible').css('display'), 'block', 'visible on first toggle');
			$collapse.toggle();
			equal($('#qunit-fixture .collapsible').css('display'), 'none', 'invisible on second toggle');
		});
		...
		test('should toggle when it is default opened', function() {
			...
			var $collapse = $.scojs_collapse('#link', {ease: ''}).toggle();
			equal($('#qunit-fixture .collapsible').css('display'), 'none', 'invisible on first toggle');
			$collapse.toggle();
			equal($('#qunit-fixture .collapsible').css('display'), 'block', 'visible on second toggle');
		});
		...
		test('should toggle when target is specified', function() {
			...
			equal($('#qunit-fixture .foo').css('display'), 'block', 'visible on first toggle');
			equal($('#qunit-fixture .ignored').css('display'), 'block', '.ignored is not affected on first toggle');
			$collapse.toggle();
			equal($('#qunit-fixture .foo').css('display'), 'none', 'invisible on second toggle');
			equal($('#qunit-fixture .ignored').css('display'), 'block', '.ignored is not affected on second toggle');
		});
	...
	module('collapse data-api');
		...
		test('should toggle the target on click', function() {
			...
			equal($('#qunit-fixture .collapsible').css('display'), 'block', 'visible on first click');
			$('#qunit-fixture #link').trigger('click');
			equal($('#qunit-fixture .collapsible').css('display'), 'none', 'invisible on second click');
		});
		...
		test('should toggle all in accordion mode', function() {
			...
			equal($('#qunit-fixture .collapsible').eq(0).css('display'), 'block', 'first collapsible should be visible');
			ok(!$('#qunit-fixture #link2').hasClass('active'), 'other link should NOT have class .active');
			equal($('#qunit-fixture .collapsible').eq(1).css('display'), 'none', 'second collapsible should NOT be visible');
			$('#qunit-fixture #link1').trigger('click');
			ok(!$('#qunit-fixture #link1').hasClass('active'), 'after second click, the clicked link should NOT have class .active');
			equal($('#qunit-fixture .collapsible').eq(0).css('display'), 'none', 'first collapsible should NOT be visible');
			ok(!$('#qunit-fixture #link2').hasClass('active'), 'other link should NOT have class .active');
			equal($('#qunit-fixture .collapsible').eq(1).css('display'), 'none', 'second collapsible should NOT be visible');
			...
			equal($('#qunit-fixture .collapsible').eq(0).css('display'), 'none', 'after third click, first collapsible should NOT be visible');
			ok($('#qunit-fixture #link2').hasClass('active'), 'after third click, other link should have class .active');
			equal($('#qunit-fixture .collapsible').eq(1).css('display'), 'block', 'after third click, second collapsible should be visible');
		});
});
